...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"back"}"><title>Team.Live_Liner</title>
<div id="${"carouselExampleIndicators"}" class="${"carousel slide"}"><div class="${"carousel-indicators"}"><button type="${"button"}" data-bs-target="${"#carouselExampleIndicators"}" data-bs-slide-to="${"0"}" class="${"active"}" aria-current="${"true"}" aria-label="${"Slide 1"}"></button>
    ...
    <div class="${"carousel-inner"}"><div class="${"carousel-item active"}"><img src="${"/img/404.jpg"}" class="${"d-block w-100"}" alt="${"..."}"></div>
      <div class="${"carousel-item"}"><img src="${"/img/blog1.png"}" class="${"d-block w-100"}" alt="${"..."}"></div></div>
